...
function addGamesToPage(games) {
    ...
    games.forEach(game => {
        ...
        gamesContainer.appendChild(gameCard); // Use the declared gamesContainer
    });
}
...
function filterUnfundedOnly() {
    ...
    console.log('Unfunded games count:', unfundedGames.length); // Log for Secret Key
...
function filterFundedOnly() {
    ...
    console.log('Funded games count:', fundedGames.length); // Log for Secret Key
...
const unfundedMessage = `We currently have ${unfundedCount} game${unfundedCount === 1 ? '' : 's'} that still need funding to reach their goals.`;
